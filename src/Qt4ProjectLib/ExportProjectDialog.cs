...
namespace Digia.Qt4ProjectLib
{
    ...
    internal class ExportProjectDialog : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.newButton = new ImageButton(HelperFunctions.GetSharedImage("Qt4ProjectLib.Images.newitem.png"), 
                HelperFunctions.GetSharedImage("Qt4ProjectLib.Images.newitem_d.png"));
            this.delButton = new ImageButton(HelperFunctions.GetSharedImage("Qt4ProjectLib.Images.delete.png"), 
                HelperFunctions.GetSharedImage("Qt4ProjectLib.Images.delete_d.png"));
