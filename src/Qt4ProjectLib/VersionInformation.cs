...
namespace Digia.Qt4ProjectLib
{
    ...
    public class VersionInformation
    {
        ...
        private String Locate_qglobal_h()
        {
            ...
            throw new Qt4VSException("qglobal.h not found");
        }
        ...
        public bool is64Bit()
        {
            ...
            if (!File.Exists(fileToCheck))
                throw new Qt4VSException("Can't find " + fileToCheck);
            ...
            if (!success)
                throw new Qt4VSException("GetBinaryTypeA failed");
            ...
            throw new Qt4VSException("GetBinaryTypeA return unknown executable format for " + fileToCheck);
        }
    }
}
