    ...
    public class HelperFunctions
    {
        ...
        public static void ToggleProjectKind(EnvDTE.Project project)
        {
            ...
            if (IsQt4Project(project))
            {
                ...
                {
                    if (global.StartsWith("Qt4Version"))
                    {
        ...
        public static string GetTemplatePath()
        {
            ...
            {
                throw new Qt4VSException(SR.GetString("HelperFunctions_ErrorSearchForQtTemplatePath"));
            }
        }
        ...
        public static bool SetEnvironmentVariableEx(string environmentVariable, string variableValue)
        {
            ...
            {
                throw new Qt4VSException(SR.GetString("HelperFunctions_CannotWriteEnvQTDIR"));
            }
        }
